...
PURPOSE: Fogbots Log in Page

ORIGINALLY CREATED ON: 27 July 2017
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <h2><%: Title %>.</h2>
        ...
        <asp:Label runat="server" ID="loginError" CssClass="text-danger" ></asp:Label>
    ...
    <div class="row">
        <div class="col-md-8">
            <section id="loginForm">
                ...
                <p>
                    <asp:HyperLink runat="server" ID="RegisterHyperLink" ViewStateMode="Disabled" NavigateUrl="~/Account/Register.aspx">Register here</asp:HyperLink>
